  ...
  sim_icache_fetch(23 + t_thisfile.offset, 1);
{
  ...
  sim_icache_fetch(24 + t_thisfile.offset, 32);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(32);
   ...
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 36),0,4), 0); /* line 119 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 40),0,4), 0); /* line 120 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 44),0,4), 0); /* line 121 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 48),0,4), 0); /* line 122 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 52),0,4), 0); /* line 123 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 56),0,4), 0); /* line 124 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 60),0,4), 0); /* line 125 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 64),0,4), 0); /* line 126 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 68),0,4), 0); /* line 127 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 72),0,4), 0); /* line 128 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 76),0,4), 0); /* line 129 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 80),0,4), 0); /* line 130 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 84),0,4), 0); /* line 131 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 88),0,4), 0); /* line 132 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 92),0,4), 0); /* line 133 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 96),0,4), 0); /* line 134 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 100),0,4), 0); /* line 135 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 104),0,4), 0); /* line 136 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 108),0,4), 0); /* line 137 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 112),0,4), 0); /* line 138 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 116),0,4), 0); /* line 139 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 120),0,4), 0); /* line 140 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 124),0,4), 0); /* line 141 */
} /* line 141 */
  sim_icache_fetch(56 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_3, reg_r0_3, (unsigned int) 128); /* line 143 */
  ...
  sim_icache_fetch(58 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __MOV(reg_r0_3, (unsigned int) -58); /* line 148 */
   __MOV(reg_r0_6, 0); /* line 149 */
   __MOV(reg_r0_43, ((unsigned int) conv7_result + (unsigned int) 780)); /* line 150 */
} /* line 150 */
l_L4X3: ;/* line 153 */
__LABEL(l_L4X3);
  sim_icache_fetch(62 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __CMPLT(reg_b0_0, reg_r0_3, 0); /* line 154 */
   __MOV(reg_r0_4, 0); /* line 155 */
   __MOV(reg_r0_2, (unsigned int) -58); /* line 156 */
   __MOV(reg_r0_44, reg_r0_3); /* line 157 */
} /* line 157 */
...
l_L6X3: ;/* line 162 */
__LABEL(l_L6X3);
  sim_icache_fetch(67 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __CMPLT(reg_b0_0, reg_r0_2, 0); /* line 163 */
   __MOV(reg_r0_3, (unsigned int) -7); /* line 164 */
   __MOV(reg_r0_10, (unsigned int) filter7x7); /* line 165 */
   __MOV(reg_r0_5, reg_r0_4); /* line 166 */
   __MOV(reg_r0_9, 0); /* line 167 */
   __MOV(reg_r0_8, 0); /* line 168 */
   __MOV(reg_r0_14, 0); /* line 169 */
   __MOV(reg_r0_41, reg_r0_2); /* line 170 */
   __MOV(reg_r0_42, reg_r0_4); /* line 171 */
} /* line 171 */
...
l_L8X3: ;/* line 176 */
__LABEL(l_L8X3);
  sim_icache_fetch(78 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __CMPLT(reg_b0_0, reg_r0_3, 0); /* line 177 */
   __ADD(reg_r0_7, reg_r0_5, reg_r0_6); /* line 178 */
   __MOV(reg_r0_4, reg_r0_10); /* line 179 */
   __MOV(reg_r0_15, 0); /* line 180 */
   __MOV(reg_r0_12, 0); /* line 181 */
   __MOV(reg_r0_13, 0); /* line 182 */
   __MOV(reg_r0_16, (unsigned int) -4); /* line 183 */
   __MOV(reg_r0_19, (unsigned int) 1024); /* line 184 */
   __MOV(reg_r0_37, reg_r0_3); /* line 185 */
   __MOV(reg_r0_38, reg_r0_5); /* line 186 */
   __MOV(reg_r0_39, reg_r0_6); /* line 187 */
   __MOV(reg_r0_40, reg_r0_10); /* line 188 */
} /* line 188 */
  sim_icache_fetch(91 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_7, reg_r0_7, (unsigned int) conv7_image); /* line 190 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L9X3; 
  ...
  sim_icache_fetch(94 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __MOV(reg_r0_2, reg_r0_7); /* line 193 */
} /* line 193 */
l_L10X3: ;/* line 196 */
__LABEL(l_L10X3);
  sim_icache_fetch(95 + t_thisfile.offset, 19);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(14);
   __PFT(mem_trace_pf((reg_r0_2 + (unsigned int) 1024),0,4)); /* line 197 */
   __LDW(reg_r0_3, mem_trace_ld(reg_r0_2,0,4)); /* line 198 */
   __PFT(mem_trace_pf((reg_r0_4 + (unsigned int) 32),0,4)); /* line 199 */
   __LDW(reg_r0_5, mem_trace_ld(reg_r0_4,0,4)); /* line 200 */
   __LDW(reg_r0_7, mem_trace_ld((reg_r0_4 + (unsigned int) 8),0,4)); /* line 201 */
   __LDW(reg_r0_11, mem_trace_ld((reg_r0_4 + (unsigned int) 4),0,4)); /* line 202 */
   __LDW(reg_r0_10, mem_trace_ld((reg_r0_2 + (unsigned int) 256),0,4)); /* line 203 */
   __LDW(reg_r0_6, mem_trace_ld((reg_r0_2 + (unsigned int) 512),0,4)); /* line 204 */
   __CMPLT(reg_b0_0, reg_r0_16, 0); /* line 205 */
   __LDWs(reg_r0_18, mem_trace_ld((reg_r0_4 + (unsigned int) 12),0,4)); /* line 206 */
   __LDWs(reg_r0_17, mem_trace_ld((reg_r0_2 + (unsigned int) 768),0,4)); /* line 207 */
   __ADD(reg_r0_16, reg_r0_16, (unsigned int) 4); /* line 208 */
   __ADD(reg_r0_2, reg_r0_2, reg_r0_19); /* line 209 */
   __ADD(reg_r0_4, reg_r0_4, (unsigned int) 16); /* line 210 */
   __INC_NOP_CNT((unsigned int) 1);
   __XNOP((unsigned int) 1); /* line 211 */
   __ADD_CYCLES(1);
} /* line 211 */
  sim_icache_fetch(114 + t_thisfile.offset, 12);
{
  ...
  t__i32_0 = reg_r0_3 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(12);
   __SHRU(reg_r0_22, t__i32_0, (unsigned int) 16); /* line 213 */
   __AND(reg_r0_3, t__i32_0, (unsigned int) 255); /* line 214 */
   __SHRU(reg_r0_20, t__i32_0, (unsigned int) 8); /* line 215 */
   __SHRU(reg_r0_25, t__i32_1, (unsigned int) 16); /* line 216 */
   __AND(reg_r0_10, t__i32_1, (unsigned int) 255); /* line 217 */
   __SHRU(reg_r0_24, t__i32_1, (unsigned int) 8); /* line 218 */
   __SHRU(reg_r0_23, t__i32_2, (unsigned int) 16); /* line 219 */
   __AND(reg_r0_6, t__i32_2, (unsigned int) 255); /* line 220 */
   __SHRU(reg_r0_21, t__i32_2, (unsigned int) 8); /* line 221 */
   __SHRU(reg_r0_27, t__i32_3, (unsigned int) 16); /* line 222 */
   __AND(reg_r0_17, t__i32_3, (unsigned int) 255); /* line 223 */
   __SHRU(reg_r0_26, t__i32_3, (unsigned int) 8); /* line 224 */
} /* line 224 */
  sim_icache_fetch(126 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __AND(reg_r0_22, reg_r0_22, (unsigned int) 255); /* line 226 */
   __MULLU(reg_r0_28, reg_r0_5, reg_r0_3); /* line 227 */
   __MULHS(reg_r0_3, reg_r0_5, reg_r0_3); /* line 228 */
   __AND(reg_r0_20, reg_r0_20, (unsigned int) 255); /* line 229 */
   __AND(reg_r0_25, reg_r0_25, (unsigned int) 255); /* line 230 */
   __MULLU(reg_r0_30, reg_r0_11, reg_r0_10); /* line 231 */
   __MULHS(reg_r0_10, reg_r0_11, reg_r0_10); /* line 232 */
   __AND(reg_r0_24, reg_r0_24, (unsigned int) 255); /* line 233 */
   __AND(reg_r0_23, reg_r0_23, (unsigned int) 255); /* line 234 */
   __MULLU(reg_r0_29, reg_r0_7, reg_r0_6); /* line 235 */
   __MULHS(reg_r0_6, reg_r0_7, reg_r0_6); /* line 236 */
   __AND(reg_r0_21, reg_r0_21, (unsigned int) 255); /* line 237 */
   __AND(reg_r0_27, reg_r0_27, (unsigned int) 255); /* line 238 */
   __MULLU(reg_r0_31, reg_r0_18, reg_r0_17); /* line 239 */
   __MULHS(reg_r0_17, reg_r0_18, reg_r0_17); /* line 240 */
   __AND(reg_r0_26, reg_r0_26, (unsigned int) 255); /* line 241 */
} /* line 241 */
  sim_icache_fetch(142 + t_thisfile.offset, 16);
{
  ...
  t__i32_0 = reg_r0_5 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __MULLU(reg_r0_34, t__i32_0, reg_r0_22); /* line 243 */
   __MULHS(reg_r0_5, t__i32_0, reg_r0_22); /* line 244 */
   __MULLU(reg_r0_32, t__i32_0, reg_r0_20); /* line 245 */
   __MULHS(reg_r0_20, t__i32_0, reg_r0_20); /* line 246 */
   __MULLU(reg_r0_35, t__i32_1, reg_r0_25); /* line 247 */
   __MULHS(reg_r0_11, t__i32_1, reg_r0_25); /* line 248 */
   __MULLU(reg_r0_23, t__i32_1, reg_r0_24); /* line 249 */
   __MULHS(reg_r0_24, t__i32_1, reg_r0_24); /* line 250 */
   __MULLU(reg_r0_22, t__i32_3, t__i32_2); /* line 251 */
   __MULHS(reg_r0_7, t__i32_3, t__i32_2); /* line 252 */
   __MULLU(reg_r0_33, t__i32_3, reg_r0_21); /* line 253 */
   __MULHS(reg_r0_21, t__i32_3, reg_r0_21); /* line 254 */
   __MULLU(reg_r0_36, t__i32_4, reg_r0_27); /* line 255 */
   __MULHS(reg_r0_18, t__i32_4, reg_r0_27); /* line 256 */
   __MULLU(reg_r0_25, t__i32_4, reg_r0_26); /* line 257 */
   __MULHS(reg_r0_26, t__i32_4, reg_r0_26); /* line 258 */
} /* line 258 */
  sim_icache_fetch(158 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_28, reg_r0_28, reg_r0_3); /* line 260 */
   __ADD(reg_r0_30, reg_r0_30, reg_r0_10); /* line 261 */
   __ADD(reg_r0_29, reg_r0_29, reg_r0_6); /* line 262 */
   __ADD(reg_r0_31, reg_r0_31, reg_r0_17); /* line 263 */
} /* line 263 */
  sim_icache_fetch(162 + t_thisfile.offset, 16);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __ADD(reg_r0_34, reg_r0_34, reg_r0_5); /* line 265 */
   __CMPLT(reg_b0_1, reg_r0_28, 0); /* line 266 */
   __ADD(reg_r0_3, reg_r0_28, (unsigned int) 255); /* line 267 */
   __ADD(reg_r0_32, reg_r0_32, reg_r0_20); /* line 268 */
   __ADD(reg_r0_35, reg_r0_35, reg_r0_11); /* line 269 */
   __CMPLT(reg_b0_3, reg_r0_30, 0); /* line 270 */
   __ADD(reg_r0_6, reg_r0_30, (unsigned int) 255); /* line 271 */
   __ADD(reg_r0_23, reg_r0_23, reg_r0_24); /* line 272 */
   __ADD(reg_r0_22, reg_r0_22, reg_r0_7); /* line 273 */
   __CMPLT(reg_b0_2, reg_r0_29, 0); /* line 274 */
   __ADD(reg_r0_5, reg_r0_29, (unsigned int) 255); /* line 275 */
   __ADD(reg_r0_33, reg_r0_33, reg_r0_21); /* line 276 */
   __ADD(reg_r0_36, reg_r0_36, reg_r0_18); /* line 277 */
   __CMPLT(reg_b0_4, reg_r0_31, 0); /* line 278 */
   __ADD(reg_r0_7, reg_r0_31, (unsigned int) 255); /* line 279 */
   __ADD(reg_r0_25, reg_r0_25, reg_r0_26); /* line 280 */
} /* line 280 */
  sim_icache_fetch(178 + t_thisfile.offset, 21);
{
  ...
  t__i32_1 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(21);
   __CMPLT(reg_b0_7, reg_r0_34, 0); /* line 282 */
   __ADD(reg_r0_17, reg_r0_34, (unsigned int) 255); /* line 283 */
   __SLCT(reg_r0_3, reg_b0_1, reg_r0_3, reg_r0_28); /* line 284 */
   __CMPLT(reg_b0_5, reg_r0_32, 0); /* line 285 */
   __ADD(reg_r0_10, reg_r0_32, (unsigned int) 255); /* line 286 */
   __CMPLT(reg_b0_3, reg_r0_35, 0); /* line 287 */
   __ADD(reg_r0_27, reg_r0_35, (unsigned int) 255); /* line 288 */
   __CMPLT(reg_b0_0, reg_r0_23, 0); /* line 289 */
   __ADD(reg_r0_24, reg_r0_23, (unsigned int) 255); /* line 290 */
   __CMPLT(reg_b0_4, reg_r0_22, 0); /* line 291 */
   __ADD(reg_r0_20, reg_r0_22, (unsigned int) 255); /* line 292 */
   __SLCT(reg_r0_5, reg_b0_2, reg_r0_5, reg_r0_29); /* line 293 */
   __CMPLT(reg_b0_6, reg_r0_33, 0); /* line 294 */
   __ADD(reg_r0_11, reg_r0_33, (unsigned int) 255); /* line 295 */
   __CMPLT(reg_b0_2, reg_r0_36, 0); /* line 296 */
   __ADD(reg_r0_29, reg_r0_36, (unsigned int) 255); /* line 297 */
   __CMPLT(reg_b0_1, reg_r0_25, 0); /* line 298 */
   __ADD(reg_r0_28, reg_r0_25, (unsigned int) 255); /* line 299 */
   __MFB(reg_r0_18, t__i32_0); /* line 300 */
   __MFB(reg_r0_21, t__i32_1); /* line 301 */
   __MFB(reg_r0_26, t__i32_2); /* line 302 */
} /* line 302 */
  sim_icache_fetch(199 + t_thisfile.offset, 13);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(13);
   __SLCT(reg_r0_17, reg_b0_7, reg_r0_17, reg_r0_34); /* line 304 */
   __SHR(reg_r0_3, reg_r0_3, (unsigned int) 8); /* line 305 */
   __SLCT(reg_r0_10, reg_b0_5, reg_r0_10, reg_r0_32); /* line 306 */
   __SLCT(reg_r0_27, reg_b0_3, reg_r0_27, reg_r0_35); /* line 307 */
   __SLCT(reg_r0_24, reg_b0_0, reg_r0_24, reg_r0_23); /* line 308 */
   __SLCT(reg_r0_20, reg_b0_4, reg_r0_20, reg_r0_22); /* line 309 */
   __SHR(reg_r0_5, reg_r0_5, (unsigned int) 8); /* line 310 */
   __SLCT(reg_r0_11, reg_b0_6, reg_r0_11, reg_r0_33); /* line 311 */
   __SLCT(reg_r0_29, reg_b0_2, reg_r0_29, reg_r0_36); /* line 312 */
   __SLCT(reg_r0_28, reg_b0_1, reg_r0_28, reg_r0_25); /* line 313 */
   __MTB(reg_b0_1, reg_r0_18); /* line 314 */
   __MTB(reg_b0_3, reg_r0_21); /* line 315 */
   __MTB(reg_b0_0, reg_r0_26); /* line 316 */
} /* line 316 */
  sim_icache_fetch(212 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __SHR(reg_r0_17, reg_r0_17, (unsigned int) 8); /* line 318 */
   __SHR(reg_r0_10, reg_r0_10, (unsigned int) 8); /* line 319 */
   __SHR(reg_r0_27, reg_r0_27, (unsigned int) 8); /* line 320 */
   __SLCT(reg_r0_6, reg_b0_0, reg_r0_6, reg_r0_30); /* line 321 */
   __SHR(reg_r0_24, reg_r0_24, (unsigned int) 8); /* line 322 */
   __SHR(reg_r0_20, reg_r0_20, (unsigned int) 8); /* line 323 */
   __SHR(reg_r0_11, reg_r0_11, (unsigned int) 8); /* line 324 */
   __ADD(reg_r0_3, reg_r0_3, reg_r0_5); /* line 325 */
   __SHR(reg_r0_29, reg_r0_29, (unsigned int) 8); /* line 326 */
   __SLCT(reg_r0_7, reg_b0_1, reg_r0_7, reg_r0_31); /* line 327 */
   __SHR(reg_r0_28, reg_r0_28, (unsigned int) 8); /* line 328 */
} /* line 328 */
  sim_icache_fetch(223 + t_thisfile.offset, 9);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_11 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __SHR(reg_r0_6, reg_r0_6, (unsigned int) 8); /* line 330 */
   __ADD(reg_r0_5, reg_r0_24, reg_r0_12); /* line 331 */
   __ADD(reg_r0_11, reg_r0_27, reg_r0_13); /* line 332 */
   __ADD(reg_r0_10, reg_r0_10, t__i32_0); /* line 333 */
   __ADD(reg_r0_14, reg_r0_3, reg_r0_14); /* line 334 */
   __ADD(reg_r0_17, reg_r0_17, reg_r0_20); /* line 335 */
   __SHR(reg_r0_7, reg_r0_7, (unsigned int) 8); /* line 336 */
   __ADD(reg_r0_27, reg_r0_27, reg_r0_29); /* line 337 */
   __ADD(reg_r0_24, reg_r0_24, reg_r0_28); /* line 338 */
} /* line 338 */
  sim_icache_fetch(232 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __ADD(reg_r0_3, reg_r0_6, reg_r0_15); /* line 340 */
   __ADD(reg_r0_8, reg_r0_10, reg_r0_8); /* line 341 */
   __ADD(reg_r0_9, reg_r0_17, reg_r0_9); /* line 342 */
   __ADD(reg_r0_13, reg_r0_27, reg_r0_13); /* line 343 */
   __ADD(reg_r0_12, reg_r0_24, reg_r0_12); /* line 344 */
   __ADD(reg_r0_6, reg_r0_6, reg_r0_7); /* line 345 */
  ...
  sim_icache_fetch(239 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_15, reg_r0_6, reg_r0_15); /* line 348 */
  ...
  sim_icache_fetch(241 + t_thisfile.offset, 7);
{
  ...
  t__i32_0 = reg_r0_5 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __ADD(reg_r0_14, reg_r0_14, reg_r0_3); /* line 353 */
   __ADD(reg_r0_9, reg_r0_9, reg_r0_11); /* line 354 */
   __ADD(reg_r0_3, reg_r0_37, (unsigned int) 1); /* line 355 */
   __ADD(reg_r0_10, reg_r0_40, (unsigned int) 28); /* line 356 */
   __ADD(reg_r0_5, reg_r0_38, (unsigned int) 4); /* line 357 */
   __MOV(reg_r0_6, reg_r0_39); /* line 358 */
   __MOV(reg_r0_2, t__i32_0); /* line 359 */
} /* line 359 */
  sim_icache_fetch(248 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_8, reg_r0_8, reg_r0_2); /* line 361 */
...
l_L9X3: ;/* line 365 */
__LABEL(l_L9X3);
  sim_icache_fetch(250 + t_thisfile.offset, 7);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(7);
   __MAX(reg_r0_14, reg_r0_14, 0); /* line 366 */
   __MAX(reg_r0_8, reg_r0_8, 0); /* line 367 */
   __MAX(reg_r0_9, reg_r0_9, 0); /* line 368 */
   __ADD(reg_r0_3, reg_r0_42, reg_r0_43); /* line 369 */
   __ADD(reg_r0_2, reg_r0_41, (unsigned int) 1); /* line 370 */
   __ADD(reg_r0_4, reg_r0_42, (unsigned int) 4); /* line 371 */
   __MOV(reg_r0_6, reg_r0_39); /* line 372 */
} /* line 372 */
  sim_icache_fetch(257 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __MIN(reg_r0_14, reg_r0_14, (unsigned int) 255); /* line 374 */
   __MIN(reg_r0_8, reg_r0_8, (unsigned int) 255); /* line 375 */
   __MIN(reg_r0_9, reg_r0_9, (unsigned int) 255); /* line 376 */
   __PFT(mem_trace_pf((reg_r0_3 + (unsigned int) 32),0,4)); /* line 377 */
} /* line 377 */
  sim_icache_fetch(261 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHL(reg_r0_8, reg_r0_8, (unsigned int) 8); /* line 379 */
   __SHL(reg_r0_9, reg_r0_9, (unsigned int) 16); /* line 380 */
} /* line 380 */
  sim_icache_fetch(263 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_14, reg_r0_14, reg_r0_9); /* line 382 */
} /* line 382 */
  sim_icache_fetch(264 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_14, reg_r0_14, reg_r0_8); /* line 384 */
} /* line 384 */
  sim_icache_fetch(265 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st(reg_r0_3,0,4), reg_r0_14); /* line 386 */
...
l_L7X3: ;/* line 390 */
__LABEL(l_L7X3);
  sim_icache_fetch(267 + t_thisfile.offset, 6);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(4);
   __ADD(reg_r0_3, reg_r0_44, (unsigned int) 1); /* line 391 */
   __ADD(reg_r0_6, reg_r0_6, (unsigned int) 256); /* line 392 */
   __ADD(reg_r0_43, reg_r0_43, (unsigned int) 256); /* line 393 */
...
__LABEL(l_L5X3);
		 /* line 397 */
  sim_icache_fetch(273 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_3, (unsigned int) _X1STRINGPACKETX1); /* line 400 */
   __INC_BTU_CNT();
   __INC_STALL_CNT();
  sim_gprof_stop(&sim_gprof_idx);
   __CALL(puts);
  ...
  sim_icache_fetch(277 + t_thisfile.offset, 3);
{
   ...
   __LDW(reg_l0_0, mem_trace_ld((reg_r0_1 + (unsigned int) 16),0,4)); /* line 403 */
   __INC_NOP_CNT((unsigned int) 1);
...
static sim_fileinfo_t t_thisfile = {"convolution_7x7.s", 288, 0, 0, 0, 2};
