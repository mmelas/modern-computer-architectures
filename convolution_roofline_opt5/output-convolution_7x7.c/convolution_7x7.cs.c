...
/* "" */
/* "-dir /home/user/tools/vex-3.43 -fmm=/home/user/workspace/assignment1/configurations/example-4-issue/configuration.mm -width 1 -c99inline -ms -prefetch -mfinline -mas_g -mas_G -O4 -o a.out" */
  ...
  sim_icache_fetch(13 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 20),0,4), reg_r0_57); /* line 97 */
  ...
  sim_icache_fetch(17 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_2, (unsigned int) -4096); /* line 100 */
   __MOV(reg_r0_3, (unsigned int) conv7_result); /* line 101 */
} /* line 101 */
l_L2X3: ;/* line 104 */
__LABEL(l_L2X3);
  sim_icache_fetch(21 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __CMPLT(reg_b0_0, reg_r0_2, 0); /* line 105 */
   __PFT(mem_trace_pf((reg_r0_3 + (unsigned int) 128),0,4)); /* line 106 */
   __ADD(reg_r0_2, reg_r0_2, (unsigned int) 32); /* line 107 */
} /* line 107 */
  sim_icache_fetch(24 + t_thisfile.offset, 1);
{
  ...
  sim_icache_fetch(25 + t_thisfile.offset, 32);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(32);
   __STW(mem_trace_st(reg_r0_3,0,4), 0); /* line 111 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 4),0,4), 0); /* line 112 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 8),0,4), 0); /* line 113 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 12),0,4), 0); /* line 114 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 16),0,4), 0); /* line 115 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 20),0,4), 0); /* line 116 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 24),0,4), 0); /* line 117 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 28),0,4), 0); /* line 118 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 32),0,4), 0); /* line 119 */
   ...
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 72),0,4), 0); /* line 129 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 76),0,4), 0); /* line 130 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 80),0,4), 0); /* line 131 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 84),0,4), 0); /* line 132 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 88),0,4), 0); /* line 133 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 92),0,4), 0); /* line 134 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 96),0,4), 0); /* line 135 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 100),0,4), 0); /* line 136 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 104),0,4), 0); /* line 137 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 108),0,4), 0); /* line 138 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 112),0,4), 0); /* line 139 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 116),0,4), 0); /* line 140 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 120),0,4), 0); /* line 141 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 124),0,4), 0); /* line 142 */
} /* line 142 */
  sim_icache_fetch(57 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_3, reg_r0_3, (unsigned int) 128); /* line 144 */
...
l_L3X3: ;/* line 148 */
__LABEL(l_L3X3);
  sim_icache_fetch(59 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __MOV(reg_r0_8, 0); /* line 149 */
   __MOV(reg_r0_3, 0); /* line 150 */
   __MOV(reg_r0_57, ((unsigned int) conv7_result + (unsigned int) 1012)); /* line 151 */
} /* line 151 */
l_L4X3: ;/* line 154 */
__LABEL(l_L4X3);
  sim_icache_fetch(63 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(3);
   __CMPLT(reg_b0_0, reg_r0_3, (unsigned int) 58); /* line 155 */
   __MOV(reg_r0_4, (unsigned int) -58); /* line 156 */
   __MOV(reg_r0_7, 0); /* line 157 */
} /* line 157 */
...
l_L6X3: ;/* line 162 */
__LABEL(l_L6X3);
  sim_icache_fetch(67 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __CMPLT(reg_b0_0, reg_r0_4, 0); /* line 163 */
   __MOV(reg_r0_2, (unsigned int) -7); /* line 164 */
   __MOV(reg_r0_6, 0); /* line 165 */
   __MOV(reg_r0_5, reg_r0_7); /* line 166 */
   __MOV(reg_r0_22, 0); /* line 167 */
   __MOV(reg_r0_17, 0); /* line 168 */
   __MOV(reg_r0_23, 0); /* line 169 */
   __MOV(reg_r0_55, reg_r0_4); /* line 170 */
   __MOV(reg_r0_56, reg_r0_7); /* line 171 */
} /* line 171 */
...
l_L8X3: ;/* line 176 */
__LABEL(l_L8X3);
  sim_icache_fetch(77 + t_thisfile.offset, 24);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(17);
   __CMPLT(reg_b0_0, reg_r0_2, 0); /* line 177 */
   __SH2ADD(reg_r0_10, reg_r0_6, (unsigned int) filter7x7); /* line 178 */
   __ADD(reg_r0_9, reg_r0_5, reg_r0_8); /* line 179 */
   __ADD(reg_r0_18, reg_r0_3, (unsigned int) 1); /* line 180 */
   __SH2ADD(reg_r0_19, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 4)); /* line 181 */
   __ADD(reg_r0_11, reg_r0_3, (unsigned int) 2); /* line 182 */
   __SH2ADD(reg_r0_12, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 8)); /* line 183 */
   __ADD(reg_r0_13, reg_r0_3, (unsigned int) 3); /* line 184 */
   __SH2ADD(reg_r0_14, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 12)); /* line 185 */
   __ADD(reg_r0_20, reg_r0_3, (unsigned int) 4); /* line 186 */
   __SH2ADD(reg_r0_21, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 16)); /* line 187 */
   __ADD(reg_r0_15, reg_r0_3, (unsigned int) 5); /* line 188 */
   __SH2ADD(reg_r0_16, reg_r0_6, ((unsigned int) filter7x7 + (unsigned int) 20)); /* line 189 */
   ...
   __ADD(reg_r0_2, reg_r0_2, (unsigned int) 1); /* line 192 */
   __ADD(reg_r0_6, reg_r0_6, (unsigned int) 7); /* line 193 */
} /* line 193 */
  sim_icache_fetch(101 + t_thisfile.offset, 17);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __PFT(mem_trace_pf((reg_r0_10 + (unsigned int) 32),0,4)); /* line 195 */
   __LDWs(reg_r0_24, mem_trace_ld(reg_r0_10,0,4)); /* line 196 */
   ...
   __LDWs(reg_r0_21, mem_trace_ld(reg_r0_21,0,4)); /* line 205 */
   __SHL(reg_r0_15, reg_r0_15, (unsigned int) 6); /* line 206 */
   __LDWs(reg_r0_16, mem_trace_ld(reg_r0_16,0,4)); /* line 207 */
   __SHL(reg_r0_4, reg_r0_4, (unsigned int) 6); /* line 208 */
   __LDWs(reg_r0_7, mem_trace_ld(reg_r0_7,0,4)); /* line 209 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L9X3; 
  ...
  sim_icache_fetch(118 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __PFT(mem_trace_pf((reg_r0_9 + (unsigned int) 32),0,4)); /* line 212 */
   __LDW(reg_r0_10, mem_trace_ld(reg_r0_9,0,4)); /* line 213 */
   ...
   __ADD(reg_r0_5, reg_r0_5, (unsigned int) 1); /* line 220 */
} /* line 220 */
  sim_icache_fetch(127 + t_thisfile.offset, 12);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(6);
   __SH2ADD(reg_r0_18, reg_r0_18, (unsigned int) conv7_image); /* line 222 */
   __SH2ADD(reg_r0_11, reg_r0_11, (unsigned int) conv7_image); /* line 223 */
   __SH2ADD(reg_r0_13, reg_r0_13, (unsigned int) conv7_image); /* line 224 */
   __SH2ADD(reg_r0_20, reg_r0_20, (unsigned int) conv7_image); /* line 225 */
   __SH2ADD(reg_r0_15, reg_r0_15, (unsigned int) conv7_image); /* line 226 */
   __SH2ADD(reg_r0_4, reg_r0_4, (unsigned int) conv7_image); /* line 227 */
} /* line 227 */
  sim_icache_fetch(139 + t_thisfile.offset, 9);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_10 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __SHRU(reg_r0_25, t__i32_0, (unsigned int) 16); /* line 229 */
   __AND(reg_r0_10, t__i32_0, (unsigned int) 255); /* line 230 */
   __SHRU(reg_r0_9, t__i32_0, (unsigned int) 8); /* line 231 */
   __LDW(reg_r0_18, mem_trace_ld(reg_r0_18,0,4)); /* line 232 */
   __LDW(reg_r0_11, mem_trace_ld(reg_r0_11,0,4)); /* line 233 */
   __LDW(reg_r0_13, mem_trace_ld(reg_r0_13,0,4)); /* line 234 */
   __LDW(reg_r0_20, mem_trace_ld(reg_r0_20,0,4)); /* line 235 */
   __LDW(reg_r0_15, mem_trace_ld(reg_r0_15,0,4)); /* line 236 */
   __LDW(reg_r0_4, mem_trace_ld(reg_r0_4,0,4)); /* line 237 */
} /* line 237 */
  sim_icache_fetch(148 + t_thisfile.offset, 4);
{
   ...
   __MULLU(reg_r0_26, reg_r0_24, reg_r0_10); /* line 240 */
   __MULHS(reg_r0_10, reg_r0_24, reg_r0_10); /* line 241 */
   __AND(reg_r0_9, reg_r0_9, (unsigned int) 255); /* line 242 */
} /* line 242 */
  sim_icache_fetch(152 + t_thisfile.offset, 22);
{
  unsigned int t__i32_0;
  ...
  t__i32_6 = reg_r0_4 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(22);
   __MULLU(reg_r0_35, t__i32_0, reg_r0_25); /* line 244 */
   __MULHS(reg_r0_24, t__i32_0, reg_r0_25); /* line 245 */
   __MULLU(reg_r0_28, t__i32_0, reg_r0_9); /* line 246 */
   __MULHS(reg_r0_9, t__i32_0, reg_r0_9); /* line 247 */
   __SHRU(reg_r0_38, t__i32_1, (unsigned int) 16); /* line 248 */
   __AND(reg_r0_18, t__i32_1, (unsigned int) 255); /* line 249 */
   __SHRU(reg_r0_32, t__i32_1, (unsigned int) 8); /* line 250 */
   __SHRU(reg_r0_25, t__i32_2, (unsigned int) 16); /* line 251 */
   __AND(reg_r0_11, t__i32_2, (unsigned int) 255); /* line 252 */
   __SHRU(reg_r0_29, t__i32_2, (unsigned int) 8); /* line 253 */
   __SHRU(reg_r0_36, t__i32_3, (unsigned int) 16); /* line 254 */
   __AND(reg_r0_13, t__i32_3, (unsigned int) 255); /* line 255 */
   __SHRU(reg_r0_30, t__i32_3, (unsigned int) 8); /* line 256 */
   __SHRU(reg_r0_39, t__i32_4, (unsigned int) 16); /* line 257 */
   __AND(reg_r0_20, t__i32_4, (unsigned int) 255); /* line 258 */
   __SHRU(reg_r0_33, t__i32_4, (unsigned int) 8); /* line 259 */
   __SHRU(reg_r0_37, t__i32_5, (unsigned int) 16); /* line 260 */
   __AND(reg_r0_15, t__i32_5, (unsigned int) 255); /* line 261 */
   __SHRU(reg_r0_31, t__i32_5, (unsigned int) 8); /* line 262 */
   __SHRU(reg_r0_34, t__i32_6, (unsigned int) 16); /* line 263 */
   __AND(reg_r0_4, t__i32_6, (unsigned int) 255); /* line 264 */
   __SHRU(reg_r0_27, t__i32_6, (unsigned int) 8); /* line 265 */
} /* line 265 */
  sim_icache_fetch(174 + t_thisfile.offset, 25);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(25);
   __ADD(reg_r0_26, reg_r0_26, reg_r0_10); /* line 267 */
   __AND(reg_r0_38, reg_r0_38, (unsigned int) 255); /* line 268 */
   __MULLU(reg_r0_43, reg_r0_19, reg_r0_18); /* line 269 */
   __MULHS(reg_r0_18, reg_r0_19, reg_r0_18); /* line 270 */
   ...
   __MULLU(reg_r0_10, reg_r0_12, reg_r0_11); /* line 274 */
   ...
   __MULLU(reg_r0_44, reg_r0_21, reg_r0_20); /* line 282 */
   __MULHS(reg_r0_20, reg_r0_21, reg_r0_20); /* line 283 */
  ...
  sim_icache_fetch(199 + t_thisfile.offset, 28);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  unsigned int t__i32_2;
  ...
  t__i32_9 = reg_r0_7 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(28);
   __ADD(reg_r0_35, reg_r0_35, reg_r0_24); /* line 293 */
   __CMPLT(reg_b0_0, reg_r0_26, 0); /* line 294 */
   __ADD(reg_r0_38, reg_r0_26, (unsigned int) 255); /* line 295 */
   __ADD(reg_r0_28, reg_r0_28, reg_r0_9); /* line 296 */
   __MULLU(reg_r0_36, t__i32_1, t__i32_0); /* line 297 */
   __MULHS(reg_r0_19, t__i32_1, t__i32_0); /* line 298 */
   __MULLU(reg_r0_48, t__i32_1, reg_r0_32); /* line 299 */
   __MULHS(reg_r0_32, t__i32_1, reg_r0_32); /* line 300 */
   __MULLU(reg_r0_24, t__i32_2, reg_r0_25); /* line 301 */
   __MULHS(reg_r0_12, t__i32_2, reg_r0_25); /* line 302 */
   __MULLU(reg_r0_9, t__i32_2, reg_r0_29); /* line 303 */
   __MULHS(reg_r0_29, t__i32_2, reg_r0_29); /* line 304 */
   __MULLU(reg_r0_25, t__i32_4, t__i32_3); /* line 305 */
   __MULHS(reg_r0_14, t__i32_4, t__i32_3); /* line 306 */
   __MULLU(reg_r0_46, t__i32_4, reg_r0_30); /* line 307 */
   __MULHS(reg_r0_30, t__i32_4, reg_r0_30); /* line 308 */
   __MULLU(reg_r0_37, t__i32_5, reg_r0_39); /* line 309 */
   __MULHS(reg_r0_21, t__i32_5, reg_r0_39); /* line 310 */
   __MULLU(reg_r0_49, t__i32_5, reg_r0_33); /* line 311 */
   __MULHS(reg_r0_33, t__i32_5, reg_r0_33); /* line 312 */
   __MULLU(reg_r0_34, t__i32_7, t__i32_6); /* line 313 */
   __MULHS(reg_r0_16, t__i32_7, t__i32_6); /* line 314 */
   __MULLU(reg_r0_47, t__i32_7, reg_r0_31); /* line 315 */
   __MULHS(reg_r0_31, t__i32_7, reg_r0_31); /* line 316 */
   __MULLU(reg_r0_50, t__i32_9, t__i32_8); /* line 317 */
   __MULHS(reg_r0_7, t__i32_9, t__i32_8); /* line 318 */
   __MULLU(reg_r0_45, t__i32_9, reg_r0_27); /* line 319 */
   __MULHS(reg_r0_27, t__i32_9, reg_r0_27); /* line 320 */
} /* line 320 */
  sim_icache_fetch(227 + t_thisfile.offset, 11);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(11);
   __CMPLT(reg_b0_2, reg_r0_35, 0); /* line 322 */
   __ADD(reg_r0_51, reg_r0_35, (unsigned int) 255); /* line 323 */
   __SLCT(reg_r0_38, reg_b0_0, reg_r0_38, reg_r0_26); /* line 324 */
   __CMPLT(reg_b0_1, reg_r0_28, 0); /* line 325 */
   __ADD(reg_r0_39, reg_r0_28, (unsigned int) 255); /* line 326 */
   __ADD(reg_r0_43, reg_r0_43, reg_r0_18); /* line 327 */
   __ADD(reg_r0_10, reg_r0_10, reg_r0_11); /* line 328 */
   ...
   __ADD(reg_r0_40, reg_r0_40, reg_r0_4); /* line 332 */
} /* line 332 */
  sim_icache_fetch(238 + t_thisfile.offset, 27);
{
  unsigned int t__i32_0;
  t__i32_0 = reg_r0_7 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(27);
   __SLCT(reg_r0_51, reg_b0_2, reg_r0_51, reg_r0_35); /* line 334 */
   __SHR(reg_r0_38, reg_r0_38, (unsigned int) 8); /* line 335 */
   __SLCT(reg_r0_39, reg_b0_1, reg_r0_39, reg_r0_28); /* line 336 */
   __ADD(reg_r0_36, reg_r0_36, reg_r0_19); /* line 337 */
   __CMPLT(reg_b0_4, reg_r0_43, 0); /* line 338 */
   __ADD(reg_r0_13, reg_r0_43, (unsigned int) 255); /* line 339 */
   __ADD(reg_r0_48, reg_r0_48, reg_r0_32); /* line 340 */
   __ADD(reg_r0_24, reg_r0_24, reg_r0_12); /* line 341 */
   __CMPLT(reg_b0_1, reg_r0_10, 0); /* line 342 */
   __ADD(reg_r0_7, reg_r0_10, (unsigned int) 255); /* line 343 */
   __ADD(reg_r0_9, reg_r0_9, reg_r0_29); /* line 344 */
   __ADD(reg_r0_25, reg_r0_25, reg_r0_14); /* line 345 */
   __CMPLT(reg_b0_2, reg_r0_41, 0); /* line 346 */
   __ADD(reg_r0_11, reg_r0_41, (unsigned int) 255); /* line 347 */
   ...
   __ADD(reg_r0_14, reg_r0_44, (unsigned int) 255); /* line 351 */
   __ADD(reg_r0_49, reg_r0_49, reg_r0_33); /* line 352 */
   __ADD(reg_r0_34, reg_r0_34, reg_r0_16); /* line 353 */
   __CMPLT(reg_b0_3, reg_r0_42, 0); /* line 354 */
   __ADD(reg_r0_12, reg_r0_42, (unsigned int) 255); /* line 355 */
   __ADD(reg_r0_47, reg_r0_47, reg_r0_31); /* line 356 */
   __ADD(reg_r0_50, reg_r0_50, t__i32_0); /* line 357 */
   __CMPLT(reg_b0_0, reg_r0_40, 0); /* line 358 */
   __ADD(reg_r0_4, reg_r0_40, (unsigned int) 255); /* line 359 */
   __ADD(reg_r0_45, reg_r0_45, reg_r0_27); /* line 360 */
} /* line 360 */
  sim_icache_fetch(265 + t_thisfile.offset, 28);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  unsigned int t__i32_2;
  ...
  t__i32_5 = reg_b0_0 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(28);
   __SHR(reg_r0_51, reg_r0_51, (unsigned int) 8); /* line 362 */
   __SHR(reg_r0_39, reg_r0_39, (unsigned int) 8); /* line 363 */
   __ADD(reg_r0_53, reg_r0_36, (unsigned int) 255); /* line 364 */
   __CMPLT(reg_b0_3, reg_r0_48, 0); /* line 365 */
   __ADD(reg_r0_27, reg_r0_48, (unsigned int) 255); /* line 366 */
   __CMPLT(reg_b0_0, reg_r0_24, 0); /* line 367 */
   __ADD(reg_r0_33, reg_r0_24, (unsigned int) 255); /* line 368 */
   __CMPLT(reg_b0_7, reg_r0_9, 0); /* line 369 */
   __ADD(reg_r0_16, reg_r0_9, (unsigned int) 255); /* line 370 */
   __ADD(reg_r0_35, reg_r0_25, (unsigned int) 255); /* line 371 */
   __CMPLT(reg_b0_5, reg_r0_46, 0); /* line 372 */
   __ADD(reg_r0_19, reg_r0_46, (unsigned int) 255); /* line 373 */
   __ADD(reg_r0_54, reg_r0_37, (unsigned int) 255); /* line 374 */
   __CMPLT(reg_b0_2, reg_r0_49, 0); /* line 375 */
   __ADD(reg_r0_29, reg_r0_49, (unsigned int) 255); /* line 376 */
   __ADD(reg_r0_52, reg_r0_34, (unsigned int) 255); /* line 377 */
   __CMPLT(reg_b0_4, reg_r0_47, 0); /* line 378 */
   __ADD(reg_r0_21, reg_r0_47, (unsigned int) 255); /* line 379 */
   __CMPLT(reg_b0_1, reg_r0_50, 0); /* line 380 */
   __ADD(reg_r0_31, reg_r0_50, (unsigned int) 255); /* line 381 */
   __CMPLT(reg_b0_6, reg_r0_45, 0); /* line 382 */
   __ADD(reg_r0_15, reg_r0_45, (unsigned int) 255); /* line 383 */
   __MFB(reg_r0_18, t__i32_0); /* line 384 */
   __MFB(reg_r0_20, t__i32_1); /* line 385 */
   __MFB(reg_r0_26, t__i32_2); /* line 386 */
   __MFB(reg_r0_28, t__i32_3); /* line 387 */
   __MFB(reg_r0_30, t__i32_4); /* line 388 */
   __MFB(reg_r0_32, t__i32_5); /* line 389 */
} /* line 389 */
  sim_icache_fetch(293 + t_thisfile.offset, 16);
{
  unsigned int t__i32_0;
  unsigned int t__i32_1;
  t__i32_0 = reg_b0_2 ;
  t__i32_1 = reg_b0_1 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __CMPLT(reg_b0_2, reg_r0_36, 0); /* line 391 */
   __SLCT(reg_r0_27, reg_b0_3, reg_r0_27, reg_r0_48); /* line 392 */
   __SLCT(reg_r0_33, reg_b0_0, reg_r0_33, reg_r0_24); /* line 393 */
   __SLCT(reg_r0_16, reg_b0_7, reg_r0_16, reg_r0_9); /* line 394 */
   __CMPLT(reg_b0_0, reg_r0_25, 0); /* line 395 */
   __SLCT(reg_r0_19, reg_b0_5, reg_r0_19, reg_r0_46); /* line 396 */
   __CMPLT(reg_b0_3, reg_r0_37, 0); /* line 397 */
   __SLCT(reg_r0_29, t__i32_0, reg_r0_29, reg_r0_49); /* line 398 */
   __CMPLT(reg_b0_1, reg_r0_34, 0); /* line 399 */
   __SLCT(reg_r0_21, reg_b0_4, reg_r0_21, reg_r0_47); /* line 400 */
   __SLCT(reg_r0_31, t__i32_1, reg_r0_31, reg_r0_50); /* line 401 */
   __SLCT(reg_r0_15, reg_b0_6, reg_r0_15, reg_r0_45); /* line 402 */
   __MTB(reg_b0_7, reg_r0_26); /* line 403 */
   __MTB(reg_b0_6, reg_r0_28); /* line 404 */
   __MTB(reg_b0_5, reg_r0_30); /* line 405 */
   __MTB(reg_b0_4, reg_r0_32); /* line 406 */
} /* line 406 */
  sim_icache_fetch(309 + t_thisfile.offset, 18);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(18);
   __SLCT(reg_r0_53, reg_b0_2, reg_r0_53, reg_r0_36); /* line 408 */
   __SHR(reg_r0_27, reg_r0_27, (unsigned int) 8); /* line 409 */
   __SHR(reg_r0_33, reg_r0_33, (unsigned int) 8); /* line 410 */
   __SLCT(reg_r0_7, reg_b0_5, reg_r0_7, reg_r0_10); /* line 411 */
   __SHR(reg_r0_16, reg_r0_16, (unsigned int) 8); /* line 412 */
   __SLCT(reg_r0_35, reg_b0_0, reg_r0_35, reg_r0_25); /* line 413 */
   __SLCT(reg_r0_11, reg_b0_6, reg_r0_11, reg_r0_41); /* line 414 */
   __SHR(reg_r0_19, reg_r0_19, (unsigned int) 8); /* line 415 */
   __SLCT(reg_r0_54, reg_b0_3, reg_r0_54, reg_r0_37); /* line 416 */
   __SHR(reg_r0_29, reg_r0_29, (unsigned int) 8); /* line 417 */
   __SLCT(reg_r0_52, reg_b0_1, reg_r0_52, reg_r0_34); /* line 418 */
   __SLCT(reg_r0_12, reg_b0_7, reg_r0_12, reg_r0_42); /* line 419 */
   __SHR(reg_r0_21, reg_r0_21, (unsigned int) 8); /* line 420 */
   __SHR(reg_r0_31, reg_r0_31, (unsigned int) 8); /* line 421 */
   __SLCT(reg_r0_4, reg_b0_4, reg_r0_4, reg_r0_40); /* line 422 */
   __SHR(reg_r0_15, reg_r0_15, (unsigned int) 8); /* line 423 */
   __MTB(reg_b0_1, reg_r0_18); /* line 424 */
   __MTB(reg_b0_0, reg_r0_20); /* line 425 */
} /* line 425 */
  sim_icache_fetch(327 + t_thisfile.offset, 15);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(15);
   __SHR(reg_r0_53, reg_r0_53, (unsigned int) 8); /* line 427 */
   __SLCT(reg_r0_13, reg_b0_0, reg_r0_13, reg_r0_43); /* line 428 */
   __SHR(reg_r0_7, reg_r0_7, (unsigned int) 8); /* line 429 */
   __SHR(reg_r0_35, reg_r0_35, (unsigned int) 8); /* line 430 */
   __SHR(reg_r0_11, reg_r0_11, (unsigned int) 8); /* line 431 */
   __SHR(reg_r0_54, reg_r0_54, (unsigned int) 8); /* line 432 */
   __SLCT(reg_r0_14, reg_b0_1, reg_r0_14, reg_r0_44); /* line 433 */
   __SHR(reg_r0_52, reg_r0_52, (unsigned int) 8); /* line 434 */
   __SHR(reg_r0_12, reg_r0_12, (unsigned int) 8); /* line 435 */
   __SHR(reg_r0_4, reg_r0_4, (unsigned int) 8); /* line 436 */
   __ADD(reg_r0_39, reg_r0_39, reg_r0_15); /* line 437 */
   __ADD(reg_r0_17, reg_r0_17, reg_r0_21); /* line 438 */
   __ADD(reg_r0_27, reg_r0_27, reg_r0_29); /* line 439 */
   __ADD(reg_r0_16, reg_r0_16, reg_r0_19); /* line 440 */
   __ADD(reg_r0_51, reg_r0_51, reg_r0_31); /* line 441 */
} /* line 441 */
  sim_icache_fetch(342 + t_thisfile.offset, 10);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(10);
   __SHR(reg_r0_13, reg_r0_13, (unsigned int) 8); /* line 443 */
   __SHR(reg_r0_14, reg_r0_14, (unsigned int) 8); /* line 444 */
   __ADD(reg_r0_39, reg_r0_39, reg_r0_16); /* line 445 */
   __ADD(reg_r0_17, reg_r0_17, reg_r0_27); /* line 446 */
   __ADD(reg_r0_38, reg_r0_38, reg_r0_4); /* line 447 */
   __ADD(reg_r0_23, reg_r0_23, reg_r0_12); /* line 448 */
   __ADD(reg_r0_7, reg_r0_7, reg_r0_11); /* line 449 */
   __ADD(reg_r0_22, reg_r0_22, reg_r0_52); /* line 450 */
   __ADD(reg_r0_53, reg_r0_53, reg_r0_54); /* line 451 */
   __ADD(reg_r0_33, reg_r0_33, reg_r0_35); /* line 452 */
} /* line 452 */
  sim_icache_fetch(352 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __ADD(reg_r0_17, reg_r0_39, reg_r0_17); /* line 454 */
   __ADD(reg_r0_13, reg_r0_13, reg_r0_14); /* line 455 */
   __ADD(reg_r0_38, reg_r0_38, reg_r0_7); /* line 456 */
   __ADD(reg_r0_51, reg_r0_51, reg_r0_33); /* line 457 */
   __ADD(reg_r0_22, reg_r0_22, reg_r0_53); /* line 458 */
} /* line 458 */
  sim_icache_fetch(357 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_23, reg_r0_23, reg_r0_13); /* line 460 */
   __ADD(reg_r0_22, reg_r0_51, reg_r0_22); /* line 461 */
} /* line 461 */
  sim_icache_fetch(359 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_23, reg_r0_38, reg_r0_23); /* line 463 */
...
l_L9X3: ;/* line 467 */
__LABEL(l_L9X3);
  sim_icache_fetch(361 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __MAX(reg_r0_23, reg_r0_23, 0); /* line 468 */
   __MAX(reg_r0_17, reg_r0_17, 0); /* line 469 */
   __MAX(reg_r0_22, reg_r0_22, 0); /* line 470 */
   __SH2ADD(reg_r0_2, reg_r0_55, reg_r0_57); /* line 471 */
   __ADD(reg_r0_4, reg_r0_55, (unsigned int) 1); /* line 472 */
} /* line 472 */
  sim_icache_fetch(366 + t_thisfile.offset, 5);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(5);
   __MIN(reg_r0_23, reg_r0_23, (unsigned int) 255); /* line 474 */
   __MIN(reg_r0_17, reg_r0_17, (unsigned int) 255); /* line 475 */
   __MIN(reg_r0_22, reg_r0_22, (unsigned int) 255); /* line 476 */
   __PFT(mem_trace_pf((reg_r0_2 + (unsigned int) 32),0,4)); /* line 477 */
   __ADD(reg_r0_7, reg_r0_56, (unsigned int) 1); /* line 478 */
} /* line 478 */
  ...
  sim_icache_fetch(377 + t_thisfile.offset, 5);
{
   ...
   __ADD(reg_r0_57, reg_r0_57, (unsigned int) 256); /* line 494 */
  ...
  sim_icache_fetch(382 + t_thisfile.offset, 4);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_3, (unsigned int) _X1STRINGPACKETX1); /* line 501 */
   __INC_BTU_CNT();
   __INC_STALL_CNT();
  sim_gprof_stop(&sim_gprof_idx);
   __CALL(puts);
  ...
  sim_icache_fetch(386 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_3, 0); /* line 503 */
   __LDW(reg_l0_0, mem_trace_ld((reg_r0_1 + (unsigned int) 16),0,4)); /* line 504 */
   __INC_NOP_CNT((unsigned int) 1);
   __XNOP((unsigned int) 1); /* line 505 */
   __ADD_CYCLES(1);
} /* line 505 */
