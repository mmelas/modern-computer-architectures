...
/* "" */
/* "-dir /home/user/tools/vex-3.43 -fmm=/home/user/workspace/assignment1/configurations/example-4-issue/configuration.mm -width 1 -c99inline -ms -mas_g -mas_G -O4 -o a.out" */
  ...
  sim_icache_fetch(40 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __MOV(reg_r0_29, ((unsigned int) conv7_result + (unsigned int) 780)); /* line 143 */
} /* line 143 */
  sim_icache_fetch(42 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __MOV(reg_r0_31, reg_r0_4); /* line 145 */
} /* line 145 */
l_L4X3: ;/* line 148 */
__LABEL(l_L4X3);
  ...
  sim_icache_fetch(47 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __MOV(reg_r0_30, reg_r0_3); /* line 155 */
} /* line 155 */
l_L6X3: ;/* line 158 */
__LABEL(l_L6X3);
  ...
  sim_icache_fetch(56 + t_thisfile.offset, 2);
{
   ...
   __MOV(reg_r0_27, reg_r0_2); /* line 171 */
} /* line 171 */
  sim_icache_fetch(58 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __MOV(reg_r0_28, reg_r0_4); /* line 173 */
} /* line 173 */
l_L8X3: ;/* line 176 */
__LABEL(l_L8X3);
  ...
  sim_icache_fetch(69 + t_thisfile.offset, 2);
{
   ...
   __MOV(reg_r0_23, reg_r0_3); /* line 192 */
} /* line 192 */
  sim_icache_fetch(71 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_24, reg_r0_12); /* line 194 */
   __MOV(reg_r0_25, reg_r0_13); /* line 195 */
} /* line 195 */
  sim_icache_fetch(73 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __MOV(reg_r0_26, reg_r0_15); /* line 197 */
} /* line 197 */
l_L10X3: ;/* line 200 */
__LABEL(l_L10X3);
  ...
  sim_icache_fetch(82 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __AND(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 213 */
   __MULLU(reg_r0_16, reg_r0_12, reg_r0_13); /* line 214 */
} /* line 214 */
  sim_icache_fetch(84 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MULHS(reg_r0_13, reg_r0_12, reg_r0_13); /* line 216 */
   __LDW(reg_r0_17, mem_trace_ld((reg_r0_4 + (unsigned int) 4),0,4)); /* line 217 */
} /* line 217 */
  sim_icache_fetch(86 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __LDW(reg_r0_18, mem_trace_ld((reg_r0_2 + (unsigned int) 512),0,4)); /* line 219 */
} /* line 219 */
  sim_icache_fetch(88 + t_thisfile.offset, 2);
{
  ...
  t__i32_0 = reg_r0_13 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MULLU(reg_r0_13, reg_r0_12, reg_r0_15); /* line 221 */
   __ADD(reg_r0_16, reg_r0_16, t__i32_0); /* line 222 */
} /* line 222 */
  sim_icache_fetch(90 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __CMPLT(reg_b0_1, reg_r0_16, 0); /* line 224 */
   __ADD(reg_r0_19, reg_r0_16, (unsigned int) 255); /* line 225 */
} /* line 225 */
  sim_icache_fetch(92 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SLCT(reg_r0_19, reg_b0_1, reg_r0_19, reg_r0_16); /* line 227 */
   __SHRU(reg_r0_16, reg_r0_18, (unsigned int) 8); /* line 228 */
} /* line 228 */
  sim_icache_fetch(94 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHR(reg_r0_19, reg_r0_19, (unsigned int) 8); /* line 230 */
  ...
  sim_icache_fetch(96 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHRU(reg_r0_21, reg_r0_18, (unsigned int) 16); /* line 233 */
   __MULLU(reg_r0_20, reg_r0_14, reg_r0_16); /* line 234 */
} /* line 234 */
  sim_icache_fetch(98 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __AND(reg_r0_21, reg_r0_21, (unsigned int) 255); /* line 236 */
   __MULHS(reg_r0_16, reg_r0_14, reg_r0_16); /* line 237 */
} /* line 237 */
  sim_icache_fetch(100 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MULHS(reg_r0_15, reg_r0_12, reg_r0_15); /* line 239 */
  ...
  sim_icache_fetch(102 + t_thisfile.offset, 2);
{
  ...
  t__i32_0 = reg_r0_16 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MULLU(reg_r0_16, reg_r0_14, reg_r0_21); /* line 242 */
   __ADD(reg_r0_20, reg_r0_20, t__i32_0); /* line 243 */
} /* line 243 */
  sim_icache_fetch(104 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __CMPLT(reg_b0_1, reg_r0_20, 0); /* line 245 */
   __ADD(reg_r0_22, reg_r0_20, (unsigned int) 255); /* line 246 */
} /* line 246 */
  sim_icache_fetch(106 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_13, reg_r0_13, reg_r0_15); /* line 248 */
   __SLCT(reg_r0_22, reg_b0_1, reg_r0_22, reg_r0_20); /* line 249 */
} /* line 249 */
  sim_icache_fetch(108 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __CMPLT(reg_b0_1, reg_r0_13, 0); /* line 251 */
   __SHR(reg_r0_22, reg_r0_22, (unsigned int) 8); /* line 252 */
} /* line 252 */
  sim_icache_fetch(110 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_15, reg_r0_13, (unsigned int) 255); /* line 254 */
   __ADD(reg_r0_19, reg_r0_19, reg_r0_22); /* line 255 */
} /* line 255 */
  sim_icache_fetch(112 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SLCT(reg_r0_15, reg_b0_1, reg_r0_15, reg_r0_13); /* line 257 */
   __ADD(reg_r0_5, reg_r0_19, reg_r0_5); /* line 258 */
} /* line 258 */
  sim_icache_fetch(114 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHR(reg_r0_15, reg_r0_15, (unsigned int) 8); /* line 260 */
   __MULHS(reg_r0_21, reg_r0_14, reg_r0_21); /* line 261 */
} /* line 261 */
  sim_icache_fetch(116 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __LDW(reg_r0_13, mem_trace_ld((reg_r0_2 + (unsigned int) 256),0,4)); /* line 263 */
} /* line 263 */
  sim_icache_fetch(118 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MULLU(reg_r0_19, reg_r0_12, reg_r0_3); /* line 265 */
   __ADD(reg_r0_16, reg_r0_16, reg_r0_21); /* line 266 */
} /* line 266 */
  sim_icache_fetch(120 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __CMPLT(reg_b0_1, reg_r0_16, 0); /* line 268 */
   __ADD(reg_r0_20, reg_r0_16, (unsigned int) 255); /* line 269 */
} /* line 269 */
  sim_icache_fetch(122 + t_thisfile.offset, 2);
{
  ...
  t__i32_0 = reg_r0_16 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHRU(reg_r0_16, reg_r0_13, (unsigned int) 8); /* line 271 */
   __SLCT(reg_r0_20, reg_b0_1, reg_r0_20, t__i32_0); /* line 272 */
} /* line 272 */
  sim_icache_fetch(124 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 274 */
   __SHR(reg_r0_20, reg_r0_20, (unsigned int) 8); /* line 275 */
} /* line 275 */
  sim_icache_fetch(126 + t_thisfile.offset, 2);
{
  ...
  t__i32_0 = reg_r0_20 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MULLU(reg_r0_20, reg_r0_17, reg_r0_16); /* line 277 */
   __ADD(reg_r0_15, reg_r0_15, t__i32_0); /* line 278 */
} /* line 278 */
  sim_icache_fetch(128 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MULHS(reg_r0_16, reg_r0_17, reg_r0_16); /* line 280 */
   __ADD(reg_r0_6, reg_r0_15, reg_r0_6); /* line 281 */
} /* line 281 */
  sim_icache_fetch(130 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MULHS(reg_r0_12, reg_r0_12, reg_r0_3); /* line 283 */
   __SHRU(reg_r0_15, reg_r0_13, (unsigned int) 16); /* line 284 */
} /* line 284 */
  sim_icache_fetch(132 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __AND(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 286 */
   __ADD(reg_r0_20, reg_r0_20, reg_r0_16); /* line 287 */
} /* line 287 */
  sim_icache_fetch(134 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __CMPLT(reg_b0_1, reg_r0_20, 0); /* line 289 */
   __ADD(reg_r0_3, reg_r0_20, (unsigned int) 255); /* line 290 */
} /* line 290 */
  sim_icache_fetch(136 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MULLU(reg_r0_16, reg_r0_17, reg_r0_15); /* line 292 */
   __SLCT(reg_r0_3, reg_b0_1, reg_r0_3, reg_r0_20); /* line 293 */
} /* line 293 */
  sim_icache_fetch(138 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MULHS(reg_r0_15, reg_r0_17, reg_r0_15); /* line 295 */
   __SHR(reg_r0_3, reg_r0_3, (unsigned int) 8); /* line 296 */
} /* line 296 */
  sim_icache_fetch(140 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_19, reg_r0_19, reg_r0_12); /* line 298 */
   __ADD(reg_r0_20, reg_r0_3, reg_r0_7); /* line 299 */
} /* line 299 */
  sim_icache_fetch(142 + t_thisfile.offset, 2);
{
   ...
   __ADD(reg_r0_16, reg_r0_16, reg_r0_15); /* line 302 */
} /* line 302 */
  sim_icache_fetch(144 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __CMPLT(reg_b0_2, reg_r0_16, 0); /* line 304 */
   __ADD(reg_r0_12, reg_r0_16, (unsigned int) 255); /* line 305 */
} /* line 305 */
  sim_icache_fetch(146 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_15, reg_r0_19, (unsigned int) 255); /* line 307 */
   __SLCT(reg_r0_12, reg_b0_2, reg_r0_12, reg_r0_16); /* line 308 */
} /* line 308 */
  sim_icache_fetch(148 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SLCT(reg_r0_15, reg_b0_1, reg_r0_15, reg_r0_19); /* line 310 */
   __SHR(reg_r0_12, reg_r0_12, (unsigned int) 8); /* line 311 */
} /* line 311 */
  sim_icache_fetch(150 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHR(reg_r0_15, reg_r0_15, (unsigned int) 8); /* line 313 */
   __ADD(reg_r0_16, reg_r0_12, reg_r0_8); /* line 314 */
} /* line 314 */
  sim_icache_fetch(152 + t_thisfile.offset, 2);
{
   ...
   __AND(reg_r0_18, reg_r0_18, (unsigned int) 255); /* line 317 */
} /* line 317 */
  sim_icache_fetch(154 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MULLU(reg_r0_19, reg_r0_14, reg_r0_18); /* line 319 */
   __LDWs(reg_r0_21, mem_trace_ld((reg_r0_4 + (unsigned int) 12),0,4)); /* line 320 */
} /* line 320 */
  sim_icache_fetch(156 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MULHS(reg_r0_14, reg_r0_14, reg_r0_18); /* line 322 */
   __ADD(reg_r0_4, reg_r0_4, (unsigned int) 16); /* line 323 */
} /* line 323 */
  sim_icache_fetch(158 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __MULLU(reg_r0_18, reg_r0_17, reg_r0_13); /* line 325 */
} /* line 325 */
  sim_icache_fetch(159 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MULHS(reg_r0_17, reg_r0_17, reg_r0_13); /* line 327 */
   __ADD(reg_r0_19, reg_r0_19, reg_r0_14); /* line 328 */
} /* line 328 */
  sim_icache_fetch(161 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __CMPLT(reg_b0_1, reg_r0_19, 0); /* line 330 */
   __ADD(reg_r0_13, reg_r0_19, (unsigned int) 255); /* line 331 */
} /* line 331 */
  sim_icache_fetch(163 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_18, reg_r0_18, reg_r0_17); /* line 333 */
   __SLCT(reg_r0_13, reg_b0_1, reg_r0_13, reg_r0_19); /* line 334 */
} /* line 334 */
  sim_icache_fetch(165 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __CMPLT(reg_b0_1, reg_r0_18, 0); /* line 336 */
   __SHR(reg_r0_13, reg_r0_13, (unsigned int) 8); /* line 337 */
} /* line 337 */
  sim_icache_fetch(167 + t_thisfile.offset, 2);
{
  ...
  t__i32_0 = reg_r0_13 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_13, reg_r0_18, (unsigned int) 255); /* line 339 */
   __ADD(reg_r0_15, reg_r0_15, t__i32_0); /* line 340 */
} /* line 340 */
  sim_icache_fetch(169 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SLCT(reg_r0_13, reg_b0_1, reg_r0_13, reg_r0_18); /* line 342 */
   __ADD(reg_r0_9, reg_r0_15, reg_r0_9); /* line 343 */
} /* line 343 */
  sim_icache_fetch(171 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __SHR(reg_r0_13, reg_r0_13, (unsigned int) 8); /* line 345 */
} /* line 345 */
  sim_icache_fetch(172 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_14, reg_r0_13, reg_r0_10); /* line 347 */
   if (!reg_b0_0) {    __BRANCHF(reg_b0_0);
      __INC_BTC_CNT();
      __INC_STALL_CNT();
      goto l_L11X3; 
  ...
  sim_icache_fetch(174 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __LDW(reg_r0_14, mem_trace_ld((reg_r0_2 + (unsigned int) 768),0,4)); /* line 350 */
} /* line 350 */
  sim_icache_fetch(176 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __ADD(reg_r0_2, reg_r0_2, (unsigned int) 1024); /* line 352 */
} /* line 352 */
  sim_icache_fetch(178 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHRU(reg_r0_15, reg_r0_14, (unsigned int) 16); /* line 354 */
   __SHRU(reg_r0_16, reg_r0_14, (unsigned int) 8); /* line 355 */
} /* line 355 */
  sim_icache_fetch(180 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __AND(reg_r0_15, reg_r0_15, (unsigned int) 255); /* line 357 */
   __AND(reg_r0_16, reg_r0_16, (unsigned int) 255); /* line 358 */
} /* line 358 */
  sim_icache_fetch(182 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MULLU(reg_r0_17, reg_r0_21, reg_r0_15); /* line 360 */
   __AND(reg_r0_14, reg_r0_14, (unsigned int) 255); /* line 361 */
} /* line 361 */
  sim_icache_fetch(184 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __MULHS(reg_r0_15, reg_r0_21, reg_r0_15); /* line 363 */
} /* line 363 */
  sim_icache_fetch(185 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __MULLU(reg_r0_18, reg_r0_21, reg_r0_16); /* line 365 */
} /* line 365 */
  sim_icache_fetch(186 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_17, reg_r0_17, reg_r0_15); /* line 367 */
   __MULHS(reg_r0_16, reg_r0_21, reg_r0_16); /* line 368 */
} /* line 368 */
  sim_icache_fetch(188 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __CMPLT(reg_b0_0, reg_r0_17, 0); /* line 370 */
   __ADD(reg_r0_15, reg_r0_17, (unsigned int) 255); /* line 371 */
} /* line 371 */
  sim_icache_fetch(190 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SLCT(reg_r0_15, reg_b0_0, reg_r0_15, reg_r0_17); /* line 373 */
   __ADD(reg_r0_18, reg_r0_18, reg_r0_16); /* line 374 */
} /* line 374 */
  sim_icache_fetch(192 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHR(reg_r0_15, reg_r0_15, (unsigned int) 8); /* line 376 */
   __CMPLT(reg_b0_0, reg_r0_18, 0); /* line 377 */
} /* line 377 */
  sim_icache_fetch(194 + t_thisfile.offset, 2);
{
  ...
  t__i32_0 = reg_r0_15 ;
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_15, reg_r0_18, (unsigned int) 255); /* line 379 */
   __ADD(reg_r0_12, reg_r0_12, t__i32_0); /* line 380 */
} /* line 380 */
  sim_icache_fetch(196 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SLCT(reg_r0_15, reg_b0_0, reg_r0_15, reg_r0_18); /* line 382 */
   __ADD(reg_r0_8, reg_r0_12, reg_r0_8); /* line 383 */
} /* line 383 */
  sim_icache_fetch(198 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MULLU(reg_r0_12, reg_r0_21, reg_r0_14); /* line 385 */
   __SHR(reg_r0_15, reg_r0_15, (unsigned int) 8); /* line 386 */
} /* line 386 */
  sim_icache_fetch(200 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MULHS(reg_r0_21, reg_r0_21, reg_r0_14); /* line 388 */
   __ADD(reg_r0_3, reg_r0_3, reg_r0_15); /* line 389 */
} /* line 389 */
  sim_icache_fetch(202 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __ADD(reg_r0_7, reg_r0_3, reg_r0_7); /* line 391 */
} /* line 391 */
  sim_icache_fetch(203 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __ADD(reg_r0_12, reg_r0_12, reg_r0_21); /* line 393 */
} /* line 393 */
  sim_icache_fetch(204 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __CMPLT(reg_b0_0, reg_r0_12, 0); /* line 395 */
   __ADD(reg_r0_3, reg_r0_12, (unsigned int) 255); /* line 396 */
} /* line 396 */
  sim_icache_fetch(206 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __SLCT(reg_r0_3, reg_b0_0, reg_r0_3, reg_r0_12); /* line 398 */
} /* line 398 */
  sim_icache_fetch(207 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __SHR(reg_r0_3, reg_r0_3, (unsigned int) 8); /* line 400 */
} /* line 400 */
  sim_icache_fetch(208 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __ADD(reg_r0_13, reg_r0_13, reg_r0_3); /* line 402 */
} /* line 402 */
  sim_icache_fetch(209 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_10, reg_r0_13, reg_r0_10); /* line 404 */
  ...
  sim_icache_fetch(211 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_12, reg_r0_24, (unsigned int) 4); /* line 409 */
   __ADD(reg_r0_15, reg_r0_26, (unsigned int) 28); /* line 410 */
} /* line 410 */
  sim_icache_fetch(213 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_5, reg_r0_5, reg_r0_20); /* line 412 */
   __ADD(reg_r0_6, reg_r0_6, reg_r0_16); /* line 413 */
} /* line 413 */
  sim_icache_fetch(215 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_3, reg_r0_23, (unsigned int) 1); /* line 415 */
   __ADD(reg_r0_9, reg_r0_9, reg_r0_14); /* line 416 */
} /* line 416 */
  sim_icache_fetch(217 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_13, reg_r0_25); /* line 418 */
  ...
  sim_icache_fetch(219 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MAX(reg_r0_9, reg_r0_9, 0); /* line 423 */
   __MAX(reg_r0_6, reg_r0_6, 0); /* line 424 */
} /* line 424 */
  sim_icache_fetch(221 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MIN(reg_r0_9, reg_r0_9, (unsigned int) 255); /* line 426 */
   __MIN(reg_r0_6, reg_r0_6, (unsigned int) 255); /* line 427 */
} /* line 427 */
  sim_icache_fetch(223 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MAX(reg_r0_5, reg_r0_5, 0); /* line 429 */
   __SHL(reg_r0_6, reg_r0_6, (unsigned int) 16); /* line 430 */
} /* line 430 */
  sim_icache_fetch(225 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MIN(reg_r0_5, reg_r0_5, (unsigned int) 255); /* line 432 */
   __OR(reg_r0_9, reg_r0_9, reg_r0_6); /* line 433 */
} /* line 433 */
  sim_icache_fetch(227 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHL(reg_r0_5, reg_r0_5, (unsigned int) 8); /* line 435 */
   __ADD(reg_r0_3, reg_r0_28, reg_r0_29); /* line 436 */
} /* line 436 */
  sim_icache_fetch(229 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __OR(reg_r0_9, reg_r0_9, reg_r0_5); /* line 438 */
   __ADD(reg_r0_4, reg_r0_28, (unsigned int) 4); /* line 439 */
} /* line 439 */
  sim_icache_fetch(231 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st(reg_r0_3,0,4), reg_r0_9); /* line 441 */
   __ADD(reg_r0_2, reg_r0_27, (unsigned int) 1); /* line 443 */
} /* line 443 */
  ...
  sim_icache_fetch(234 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __ADD(reg_r0_13, reg_r0_13, (unsigned int) 256); /* line 449 */
} /* line 449 */
  sim_icache_fetch(236 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __ADD(reg_r0_29, reg_r0_29, (unsigned int) 256); /* line 451 */
} /* line 451 */
  sim_icache_fetch(238 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __ADD(reg_r0_3, reg_r0_30, (unsigned int) 1); /* line 453 */
  ...
  sim_icache_fetch(240 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_31); /* line 458 */
} /* line 458 */
  ...
  sim_icache_fetch(245 + t_thisfile.offset, 3);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __MOV(reg_r0_3, 0); /* line 465 */
   __LDW(reg_l0_0, mem_trace_ld((reg_r0_1 + (unsigned int) 16),0,4)); /* line 466 */
   __INC_NOP_CNT((unsigned int) 1);
   __XNOP((unsigned int) 1); /* line 467 */
   __ADD_CYCLES(1);
} /* line 467 */
