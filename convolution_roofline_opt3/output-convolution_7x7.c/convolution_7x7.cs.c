  ...
  sim_icache_fetch(25 + t_thisfile.offset, 1);
{
  ...
  sim_icache_fetch(26 + t_thisfile.offset, 32);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(32);
   ...
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 32),0,4), 0); /* line 120 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 36),0,4), 0); /* line 121 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 40),0,4), 0); /* line 122 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 44),0,4), 0); /* line 123 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 48),0,4), 0); /* line 124 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 52),0,4), 0); /* line 125 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 56),0,4), 0); /* line 126 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 60),0,4), 0); /* line 127 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 64),0,4), 0); /* line 128 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 68),0,4), 0); /* line 129 */
   ...
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 108),0,4), 0); /* line 139 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 112),0,4), 0); /* line 140 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 116),0,4), 0); /* line 141 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 120),0,4), 0); /* line 142 */
   __STW(mem_trace_st((reg_r0_3 + (unsigned int) 124),0,4), 0); /* line 143 */
} /* line 143 */
  ...
  sim_icache_fetch(60 + t_thisfile.offset, 4);
{
   ...
   __STW(mem_trace_st((reg_r0_1 + (unsigned int) 16),0,4), reg_r0_4); /* line 152 */
  ...
  sim_icache_fetch(64 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __MOV(reg_r0_57, ((unsigned int) conv7_result + (unsigned int) 1012)); /* line 155 */
} /* line 155 */
l_L4X3: ;/* line 158 */
__LABEL(l_L4X3);
  ...
  sim_icache_fetch(70 + t_thisfile.offset, 9);
{
   ...
   __MOV(reg_r0_55, reg_r0_4); /* line 174 */
   __MOV(reg_r0_56, reg_r0_7); /* line 175 */
} /* line 175 */
  ...
  sim_icache_fetch(80 + t_thisfile.offset, 24);
{
  ...
  sim_icache_fetch(104 + t_thisfile.offset, 17);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(16);
   __PFT(mem_trace_pf((reg_r0_10 + (unsigned int) 32),0,4)); /* line 199 */
   __LDWs(reg_r0_24, mem_trace_ld(reg_r0_10,0,4)); /* line 200 */
  ...
  sim_icache_fetch(121 + t_thisfile.offset, 9);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(9);
   __PFT(mem_trace_pf((reg_r0_9 + (unsigned int) 32),0,4)); /* line 216 */
   __LDW(reg_r0_10, mem_trace_ld(reg_r0_9,0,4)); /* line 217 */
  ...
  sim_icache_fetch(142 + t_thisfile.offset, 9);
{
  ...
  t__i32_0 = reg_r0_10 ;
   ...
   __AND(reg_r0_10, t__i32_0, (unsigned int) 255); /* line 234 */
   __SHRU(reg_r0_9, t__i32_0, (unsigned int) 8); /* line 235 */
  ...
  sim_icache_fetch(151 + t_thisfile.offset, 4);
{
   ...
   __MULLU(reg_r0_26, reg_r0_24, reg_r0_10); /* line 244 */
   __MULHS(reg_r0_10, reg_r0_24, reg_r0_10); /* line 245 */
   __AND(reg_r0_9, reg_r0_9, (unsigned int) 255); /* line 246 */
} /* line 246 */
  sim_icache_fetch(155 + t_thisfile.offset, 22);
{
  ...
  t__i32_6 = reg_r0_4 ;
   ...
   __MULHS(reg_r0_24, t__i32_0, reg_r0_25); /* line 249 */
   __MULLU(reg_r0_28, t__i32_0, reg_r0_9); /* line 250 */
   __MULHS(reg_r0_9, t__i32_0, reg_r0_9); /* line 251 */
  ...
  sim_icache_fetch(177 + t_thisfile.offset, 25);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(25);
   __ADD(reg_r0_26, reg_r0_26, reg_r0_10); /* line 271 */
   ...
   __MULLU(reg_r0_10, reg_r0_12, reg_r0_11); /* line 278 */
  ...
  sim_icache_fetch(202 + t_thisfile.offset, 28);
{
  ...
  t__i32_9 = reg_r0_7 ;
   ...
   __MULLU(reg_r0_24, t__i32_2, reg_r0_25); /* line 305 */
   __MULHS(reg_r0_12, t__i32_2, reg_r0_25); /* line 306 */
   __MULLU(reg_r0_9, t__i32_2, reg_r0_29); /* line 307 */
  ...
  sim_icache_fetch(230 + t_thisfile.offset, 11);
{
   ...
   __ADD(reg_r0_10, reg_r0_10, reg_r0_11); /* line 332 */
  ...
  sim_icache_fetch(241 + t_thisfile.offset, 27);
{
  ...
  t__i32_0 = reg_r0_7 ;
   ...
   __ADD(reg_r0_24, reg_r0_24, reg_r0_12); /* line 345 */
   __CMPLT(reg_b0_1, reg_r0_10, 0); /* line 346 */
   __ADD(reg_r0_7, reg_r0_10, (unsigned int) 255); /* line 347 */
   __ADD(reg_r0_9, reg_r0_9, reg_r0_29); /* line 348 */
  ...
  sim_icache_fetch(268 + t_thisfile.offset, 28);
{
  ...
  t__i32_5 = reg_b0_0 ;
   ...
   __CMPLT(reg_b0_0, reg_r0_24, 0); /* line 371 */
   __ADD(reg_r0_33, reg_r0_24, (unsigned int) 255); /* line 372 */
   __CMPLT(reg_b0_7, reg_r0_9, 0); /* line 373 */
   __ADD(reg_r0_16, reg_r0_9, (unsigned int) 255); /* line 374 */
  ...
  sim_icache_fetch(296 + t_thisfile.offset, 16);
{
  ...
  t__i32_1 = reg_b0_1 ;
   ...
   __SLCT(reg_r0_33, reg_b0_0, reg_r0_33, reg_r0_24); /* line 397 */
   __SLCT(reg_r0_16, reg_b0_7, reg_r0_16, reg_r0_9); /* line 398 */
  ...
  sim_icache_fetch(312 + t_thisfile.offset, 18);
{
   ...
   __SLCT(reg_r0_7, reg_b0_5, reg_r0_7, reg_r0_10); /* line 415 */
  ...
  sim_icache_fetch(369 + t_thisfile.offset, 5);
{
   ...
   __PFT(mem_trace_pf((reg_r0_2 + (unsigned int) 32),0,4)); /* line 481 */
   __ADD(reg_r0_7, reg_r0_56, (unsigned int) 1); /* line 482 */
} /* line 482 */
  sim_icache_fetch(374 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __SHL(reg_r0_17, reg_r0_17, (unsigned int) 8); /* line 484 */
   __SHL(reg_r0_22, reg_r0_22, (unsigned int) 16); /* line 485 */
} /* line 485 */
  sim_icache_fetch(376 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_23, reg_r0_23, reg_r0_22); /* line 487 */
} /* line 487 */
  sim_icache_fetch(377 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __OR(reg_r0_23, reg_r0_23, reg_r0_17); /* line 489 */
} /* line 489 */
  sim_icache_fetch(378 + t_thisfile.offset, 2);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(2);
   __STW(mem_trace_st(reg_r0_2,0,4), reg_r0_23); /* line 491 */
  ...
  sim_icache_fetch(380 + t_thisfile.offset, 5);
{
   ...
   __ADD(reg_r0_57, reg_r0_57, (unsigned int) 256); /* line 498 */
  ...
  sim_icache_fetch(392 + t_thisfile.offset, 1);
{
   __ADD_CYCLES(1);
   __INC_BUNDLE_CNT(1);
   __LDW(reg_r0_57, mem_trace_ld((reg_r0_1 + (unsigned int) 20),0,4)); /* line 511 */
} /* line 511 */
